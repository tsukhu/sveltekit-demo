...
<div class="flex flex-row h-full">
	...
	<nav class="bg-gray-900 w-2/12 justify-between flex flex-col h-screen">
		<div class="mt-10 mb-10">
			<div class="mt-10">
				<ul class="text-center align-middle items-center text-sm font-semibold">
					<li class="mb-6">
						<a href="/">
							<span class="h-5 w-5 text-gray-300 mx-auto hover:text-green-500 "> Todo App </span>
						</a>
					</li>
					<li class="mb-6">
						<a href="/sample2">
							<span class="h-5 w-5 text-gray-300 mx-auto hover:text-green-500 "> Sample 2 </span>
						</a>
					</li>
					<li class="mb-6">
						<a href="/">
							<span class="h-5 w-5 text-gray-300 mx-auto hover:text-green-500 "> Sample 3 </span>
						</a>
					</li>
					<li>
						<a href="/">
							<span class="h-5 w-5 text-gray-300 mx-auto hover:text-green-500 "> Sample 4 </span>
						</a>
					</li>
				</ul>
			</div>
	...
	c8.9-2.3,18.2,1.2,23.4,8.7c3.2,4.4,4.4,9.9,3.5,15.3c-0.9,5.2-4.1,9.9-8.6,12.7l-27.5,17.5C44.8,102.5,42.9,103.3,40.9,103.9"
		...
		<div class="flex-1 py-6 sm:px-6 lg:px-8 bg-gray-200 ">
			<div class="px-2 py-2 sm:px-0 flex flex-col h-full">
				<div class="border-2 border-dashed border-purple-300 bg-white rounded-lg flex-1 p-2"><slot /></div>
			</div>
		</div>
	</div>
</div>
