	...
	<div class="flex flex-row flex-1">
		...
		<div class="flex-1 flex flex-col">
			...
			>
				...
				<div><a href="https://github.com/tsukhu/sveltekit-demo" target="_blank" aria-label="Github Repo" class="hover:text-green-700 dark:hover:text-green-200">Github Repo</a></div>
